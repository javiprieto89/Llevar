...
function Copy-LlevarLocalToOneDrive {
    ...
    return Invoke-TransferDispatcher -Llevar $Llevar -ExpectedSource "Local" -ExpectedDest "OneDrive" `
...
function Copy-LlevarOneDriveToLocal {
    ...
    return Invoke-TransferDispatcher -Llevar $Llevar -ExpectedSource "OneDrive" -ExpectedDest "Local" `
        -ShowProgress $ShowProgress -ProgressTop $ProgressTop
}
# ========================================================================== #
...
function Get-OneDriveAuth {
    <#
    .SYNOPSIS
        [AUXILIAR] Obtiene autenticación OneDrive
    .DESCRIPTION
