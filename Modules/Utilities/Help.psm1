...
function Show-Help {
    ...
    Write-Host ""
    Write-Host "  -Instalar            Instala Llevar en C:\Llevar con menú contextual"
    Write-Host "                       Requiere permisos de administrador"
    Write-Host "                       Configura PATH del sistema automáticamente"
    Write-Host ""
    Write-Host "  -Desinstalar         Desinstala Llevar del sistema"
    Write-Host "                       Elimina menú contextual y entrada del PATH"
    Write-Host ""
    ...
    Write-Host ""
    Write-Host "MENÚ CONTEXTUAL DE WINDOWS:" -ForegroundColor Yellow
    Write-Host "  Al instalar con -Instalar, se agrega 'Llevar A...' al menú contextual:"
    Write-Host "  • Clic derecho en cualquier archivo o carpeta"
    Write-Host "  • Seleccionar 'Llevar A...'"
    Write-Host "  • El origen se configura automáticamente"
    Write-Host "  • Se abre el menú interactivo para seleccionar destino"
    Write-Host ""
    Write-Host "MENÚ INTERACTIVO:" -ForegroundColor Yellow
    Write-Host "  Si ejecutas sin parámetros, se abre un menú visual completo:"
    Write-Host "  • Navegador de archivos integrado (estilo Norton Commander)"
    Write-Host "  • Configuración de origen y destino con preview"
    Write-Host "  • Selección de tipo de transferencia (Local, FTP, OneDrive, Dropbox)"
    Write-Host "  • Configuración de opciones de compresión"
    Write-Host "  • Modo ISO con selección de capacidad (CD/DVD/USB)"
    Write-Host ""
